...
127.0.0.1/mod_mysql_basic_imdb_movies/movies/		http://localhost/phpmyadmin/sql.php?db=mod_mysql_basic_imdb_movies&table=movies&sql_query=SELECT+%2A+FROM+movies++%0AORDER+BY+%60movies%60.%60movie_id%60++ASC&sql_signature=839a3bedfac5400407b4e29d9b3c858b87d3b5d35cad4fa4b02fffc3f4312fa4&session_max_rows=25&is_browse_distinct=0
 Weergave van records 0 - 24 (98 totaal, Query duurde 0,0010 seconden.) [movie_id: 1... - 25...]
